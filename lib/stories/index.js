...
(0, _react3.storiesOf)("ToggleList", module).addDecorator(_addonKnobs.withKnobs).add("Basic", (0, _withReadme2.default)(removeFirstLine(_ToggleButton2.default), function () {
	return _react2.default.createElement(_ToggleList2.default, null);
})).add("With Default Selected and multiSelect on", (0, _withReadme2.default)(removeFirstLine(_ToggleButton2.default), function () {
	return _react2.default.createElement(_ToggleList2.default, {
		defaultSelected: (0, _addonKnobs.array)("defaultSelected", ["Social"])
	});
})).add("With Default Selected and multiSelect off", (0, _withReadme2.default)(removeFirstLine(_ToggleButton2.default), function () {
	return _react2.default.createElement(_ToggleList2.default, {
		defaultSelected: (0, _addonKnobs.text)("defaultSelected", "Social"),
		multiSelect: false
	});
})).add("Playground", (0, _withReadme2.default)(removeFirstLine(_ToggleButton2.default), function () {
	return _react2.default.createElement(_ToggleList2.default, {
		title: (0, _addonKnobs.text)("title", "ToggleList: Meetup Categories"),
		multiSelect: (0, _addonKnobs.boolean)("multiSelect", true),
		data: (0, _addonKnobs.object)("data", [{ label: "Social", value: "Social" }, { label: "Travel", value: "Travel" }, { label: "Outdoors", value: "Outdoors" }]),
		defaultSelected: (0, _addonKnobs.array)("defaultSelected", ["Social", "Travel"])
	});
}));
...
(0, _react3.storiesOf)("CategorySearch", module).addDecorator(_addonKnobs.withKnobs).add("Basic", (0, _withReadme2.default)(removeFirstLine(_DataSearch2.default), function () {
	...
	return _react2.default.createElement(_CategorySearch2.default, {
		...
		appbaseField: (0, _addonKnobs.array)("appbaseField", ["name"]),

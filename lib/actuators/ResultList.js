	...
	_createClass(ResultList, [{
		...
		value: function cardMarkup(res) {
			...
			if (res.mode === "historic") {
				...
				var currentData = res.currentData.filter(function (item) {
					return item._id !== res.newData._id;
				});
				// append new streaming data if updated or remove if deleted
				if (res.newData._deleted) {
					data = currentData;
				} else {
					data = [res.newData].concat(_toConsumableArray(currentData));
				}
			}

			markup = data.map(function (item) {
				var result = _this6.props.onData(item._source);
				var cx = result.image ? result.image_size === "small" ? "rbc-image-active rbc-image-small" : "rbc-image-active" : "rbc-image-inactive";
				cx = cx + " " + (result.className ? result.className : "");
				var details = _react2.default.createElement(
					"div",
					{ style: { display: "flex", flexDirection: "row" } },
					result.image ? _react2.default.createElement("div", { className: "rbc-resultlist-item__image", style: { backgroundImage: "url(" + result.image + ")" } }) : null,
					_react2.default.createElement(
						"div",
						{ className: "rbc-resultlist-item__details clearfix" },
						_react2.default.createElement(
							"div",
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				{ ref: function ref(div) {
					...
					}, className: "rbc rbc-resultlist " + (this.props.className ? this.props.className : ""), style: this.props.style },
				_react2.default.createElement(
					"div",
					{ ref: function ref(div) {
...
ResultList.propTypes = {
	...
	sortBy: _propTypes2.default.oneOf(["asc", "desc", "default"]),
	sortOptions: _propTypes2.default.arrayOf(_propTypes2.default.shape({
	...
	paginationAt: _propTypes2.default.oneOf(["top", "bottom", "both"]),
	stream: _propTypes2.default.bool,
	style: _propTypes2.default.object,
	initialLoader: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.element]),
	noResults: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.element]),
	showResultStats: _propTypes2.default.bool,
	onResultStats: _propTypes2.default.func,
	...
	scrollOnTarget: _propTypes2.default.object,
	pages: _propTypes2.default.number,
	pageURLParams: _propTypes2.default.bool,

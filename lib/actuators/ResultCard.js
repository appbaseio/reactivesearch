...
var ResultCard = function (_Component) {
	...
	_createClass(ResultCard, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				"div",
				{ className: "rbc rbc-resultcard " + (this.props.className ? this.props.className : ""), ref: function ref(node) {
				...
				_react2.default.createElement(
					...
					{ ref: function ref(div) {
						...
						}, className: "rbc-resultcard-container card thumbnail " + cx, style: this.getComponentStyle() },
					title,
					sortOptions,

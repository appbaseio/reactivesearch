...
var ViewSwitcher = function (_Component) {
	...
	_createClass(ViewSwitcher, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				"div",
				(_React$createElement = { className: "rbc rbc-viewswitcher" }, _defineProperty(_React$createElement, "className", "" + (this.props.className ? this.props.className : "")), _defineProperty(_React$createElement, "style", this.props.style), _React$createElement),

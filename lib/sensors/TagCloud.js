...
var TagCloud = function (_Component) {
	...
	function TagCloud(props) {
		...
		_this.urlParams = props.URLParams ? _reactivemaps.AppbaseSensorHelper.URLParams.get(props.componentId, props.multiSelect) : null;
...
TagCloud.propTypes = {
	...
	defaultSelected: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number, _propTypes2.default.array]),

...
var TagCloud = function (_Component) {
	...
	_createClass(TagCloud, [{
		...
		value: function componentWillUpdate() {
			...
			setTimeout(function () {
				...
				if (_this2.props.multiSelect && !_.isEqual(_this2.defaultSelected, defaultValue)) {
					...
					_reactivemaps.AppbaseSensorHelper.URLParams.update(_this2.props.componentId, _obj.value, _this2.props.URLParam);
					...
					_reactivemaps.AppbaseSensorHelper.URLParams.update(_this2.props.componentId, _obj2.value, _this2.props.URLParam);
		...
		value: function setValue(value) {
			...
			_reactivemaps.AppbaseSensorHelper.URLParams.update(this.props.componentId, obj.value, this.props.URLParam);

		...
		value: function changeValue(defaultValue) {
			...
			if (!_.isEqual(this.defaultSelected, defaultValue)) {
				...
				if (!this.props.multiSelect) {
					...
					_reactivemaps.AppbaseSensorHelper.URLParams.update(this.props.componentId, this.setURLParam(_obj2.value), this.props.URLParams);
...
ToggleList.propTypes = _defineProperty({

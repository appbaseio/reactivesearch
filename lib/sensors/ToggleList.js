					...
					if (!props.multiSelect) {
						if (typeof defaultValue === "string") {
							if (_this2.defaultSelected !== defaultValue) {
								...
								_reactivemaps.AppbaseSensorHelper.URLParams.update(_this2.props.componentId, _this2.setURLParam(_obj.value), _this2.props.URLParam);
						...
						if (!_.isEqual(_this2.defaultSelected, defaultValue)) {
							(function () {
								...
								_reactivemaps.AppbaseSensorHelper.URLParams.update(_this2.props.componentId, _this2.setURLParam(obj.value), _this2.props.URLParam);

...
var NestedList = function (_Component) {
	...
	_createClass(NestedList, [{
		...
		value: function setValue(value) {
			...
			_reactivemaps.AppbaseSensorHelper.URLParams.update(this.props.componentId, paramValue, this.props.URLParams);
		...
		value: function renderItems(items) {
			...
			return items.map(function (item, index) {
				...
				var cx = (0, _classnames2.default)({
					"rbc-item-active": Array.isArray(_this11.state.selectedValues) && item.key === _this11.state.selectedValues[level],
					"rbc-item-inactive": !(Array.isArray(_this11.state.selectedValues) && item.key === _this11.state.selectedValues[level])
				});
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"button",
						{ className: "rbc-list-item " + cx, "data-value": item.value.join("@rbc@"), "data-level": level, onClick: _this11.onItemClick },
						_react2.default.createElement(
							"span",
							{ className: "rbc-label" },
							item.key,
					...
					Array.isArray(_this11.state.selectedValues) && _this11.state.selectedValues[level] === item.key && _this11.state.items[level + 1] ? _react2.default.createElement(
						"ul",

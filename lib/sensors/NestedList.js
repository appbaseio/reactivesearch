...
var NestedList = function (_Component) {
	...
	_createClass(NestedList, [{
		...
		value: function onItemClick(event) {
			var selectedValues = $(event.currentTarget).data("value").split("@rbc@");
			...
			return items.map(function (item, index) {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"button",
						{ className: "rbc-list-item " + cx, "data-value": item.value.join("@rbc@"), "data-level": level, onClick: _this12.onItemClick },
						_react2.default.createElement(
							"span",
							{ className: "rbc-label" },
							item.key,

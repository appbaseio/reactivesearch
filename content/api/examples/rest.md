...
<iframe frameborder="0" width="100%" height="600px" src="https://replit.com/@appbaseio/ReactiveSearch-API-Search-Query-Facet?lite=true"></iframe>
...
<iframe frameborder="0" width="100%" height="600px" src="https://replit.com/@appbaseio/ReactiveSearch-API-Search-Query-Facet-Result?lite=true"></iframe>
...
<iframe frameborder="0" width="100%" height="600px" src="https://replit.com/@appbaseio/ReactiveSearch-API-Search-Query-Facet-Range-Result?lite=true"></iframe>
...
<iframe frameborder="0" width="100%" height="600px" src="https://replit.com/@appbaseio/ReactiveSearch-API-Search-Query-Geo-Filter?lite=true"></iframe>

### Search on multiple indices

In this example, we make two search queries - each on a different index.

<iframe frameborder="0" width="100%" height="600px" src="https://replit.com/@appbaseio/ReactiveSearch-API-Multiple-Indices?lite=true"></iframe>
...
<iframe frameborder="0" width="100%" height="600px" src="https://replit.com/@appbaseio/ReactiveSearch-API-Group-Results?lite=true"></iframe>
...
<iframe frameborder="0" width="100%" height="600px" src="https://replit.com/@appbaseio/ReactiveSearch-API-Query-DSL?lite=true"></iframe>
...
<iframe frameborder="0" width="100%" height="600px" src="https://replit.com/@appbaseio/ReactiveSearch-API-Search-Query-Query-DSL-Facet?lite=true"></iframe>
...
<iframe frameborder="0" width="100%" height="600px" src="https://replit.com/@appbaseio/ReactiveSearch-API-Configure-Settings?lite=true"></iframe>

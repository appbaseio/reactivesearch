...
const HitTemplate = ({ hit }) => (
    <Link
        to={hit.url}
        className="tdn db pt3 pb3 blue search-result pl5 pr5 br3 br--left"
    >
        <h4 className={`${Spirit.h5} dib`}>
            {hit.title}
        </h4>
        <p className={`${Spirit.small} midgrey nudge-bottom--2`} dangerouslySetInnerHTML={{__html: hit.heading}}>

...
export default class HomePage extends Component {
	...
	render() {
		return (
			<div>
				<Navbar>
					<a className={`${boldHeading} ${logo}`} href="">
						Reactivesearch
					</a>
					<ul>
						<li>
				...
				<SlopeWrapper>
					<Flex justifyContent="space-between">
						...
						>
							...
							<Text fontSize="1rem" lineHeight="1.4rem" margin="10px 0 30px" light>
								Reactivesearch offers blazing fast ⚡ search UI components that run
								on elasticsearch
							</Text>
				...
				<Flex padding="0 3rem 3rem">
					...
					>
						...
						<Text fontSize="1rem" lineHeight="1.6rem">
							Ecommerce, Search and Media apps, we've got you covered. Lorem ipsum
							dolor sit amet, consectetur adipisicing elit. Minus, sapiente.
						</Text>
						<a className={decoratedLink} href="">
							View components
						</a>
					</Flex>
				</Flex>
				...
				<SlopeWrapper small>
					...
					>
						...
						<Text fontSize="1rem" lineHeight="1.4rem">
				...
				>
					...
					>
						Reactivesearch comes with a range of UI components making it easier for you
						to design the perfect search experience for your product.
					</Text>

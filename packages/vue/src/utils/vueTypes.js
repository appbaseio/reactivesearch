...
const types = {
	...
	sortByWithCount: VueTypes.oneOf([
		'asc',
		'desc',
		'count',
	]),
	...
	style:
		VueTypes.object,
	themePreset: VueTypes.oneOf([
		'light',
		'dark',
	]),
	// queryFormatDate: VueTypes.oneOf(VueTypes.object.keys(dateFormats)),
	queryFormatSearch: VueTypes.oneOf([
		'and',
		'or',
	]),
	queryFormatNumberBox: VueTypes.oneOf([
		'exact',
		'lte',
		'gte',
	]),
	...
	props:
		VueTypes.object,
	rangeLabelsAlign: VueTypes.oneOf([
		'left',
		'right',
	]),

...
const MOCK_SUGGESTIONS = [
	{
		...
		description: '<h3>Home Page</h3><p>Blazing fast search with Appbase</p>',
		url: null,
		_suggestion_type: 'featured',
		sectionId: 'navigation',
		sectionLabel: '<h2>Navigation Links</h2>',
		action: 'navigate',
		subAction: '{"link":"/home"}',
	...
	},
	{
		...
		description: '<h3>SearchBox</h3><p>Headless API to build search interface</p>',
		url: null,
		_suggestion_type: 'featured',
		sectionId: 'tutorials',

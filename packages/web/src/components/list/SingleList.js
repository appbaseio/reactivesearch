...
class SingleList extends Component {
	...
	updateQuery = (value) => {
		...
		this.props.updateQuery(this.props.componentId, query(value), value, this.props.filterLabel, callback);
	}
...
const mapDispatchtoProps = dispatch => ({
	...
	updateQuery: (component, query, value, label, onQueryChange) => dispatch(updateQuery(component, query, value, label, onQueryChange)),

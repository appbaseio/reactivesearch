	...
	this.renderPagination = function () {
		...
		var _loop = function _loop(i) {
			var pageBtn = React.createElement(
				"a",
				{ key: i - 1, light: true, primary: _this3.state.currentPage === i - 1, onClick: function onClick() {
		...
		return React.createElement(
			...
			React.createElement(
				"a",
				{ light: true, disabled: _this3.state.currentPage === 0, onClick: _this3.prevPage },
				"Prev"
			),
			React.createElement(
				"a",
				{ light: true, primary: _this3.state.currentPage === 0, onClick: function onClick() {
			...
			React.createElement(
				"a",
				{ light: true, disabled: _this3.state.currentPage >= _this3.state.totalPages - 1, onClick: _this3.nextPage },
				"Next"
			)
		);
	};

...
var _initialiseProps = function _initialiseProps() {
	...
	this.updateQuery = function (value) {
		...
		_this3.props.updateQuery(_this3.props.componentId, query(value), value, _this3.props.filterLabel, callback);
	};
};
...
var mapDispatchtoProps = function mapDispatchtoProps(dispatch) {
	return {
		...
		updateQuery: function updateQuery(component, query, value, label, onQueryChange) {
			return dispatch(_updateQuery(component, query, value, label, onQueryChange));
		},

...
var primary = function primary(props) {
	return (/*#__PURE__*/css("background-color:", props.theme.primaryColor, ";color:", props.theme.primaryTextColor, ";&:hover,&:focus{background-color:", darken(0.1, props.theme.primaryColor), ";}")
	);
};
